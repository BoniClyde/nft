          ...
          <div class="grid lg:grid-cols-5">
            <div class="col-span-1">
              <NuxtLink :to="{ name: 'home' }">
                ...
                >
                  <i
                    class="fa-solid fa-house text-secondary-800 dark:text-gray-300"
                  ></i>
                </button>
              </NuxtLink>
            </div>
        ...
        <template v-else>
          <div class="rounded-lg" v-if="fetchedData.length > 0">
            <p class="mt-6 text-center" v-if="search_store.searchQuery">
              Hurry! Only
              <span class="font-bold">{{ pageMeta?.total }}</span> left in
              stock. Get yours now!
            </p>
            <br />
...
.inactive {
  @apply text-secondary-800 dark:text-gray-300;
}
